    ...
    <div className="flex min-h-0 flex-1 flex-col">
      <div className="shrink-0 px-4 pb-2 pt-1">
        {/**
          ...
          * link had become a second control for one destination, ~44 px above itself.
          *
          * **The spec was amended first and this follows it** — that row is struck in
          * `ux-collections-as-scope.md`'s control table as of `151f65f`, with the switch written in
          * as its replacement. It went the other way round once, on 2026-08-31: the code was cut
          * before the document, the cut was reverted for that reason, and the document caught up.
          * The order is the point, and it is why this comment cites a table rather than a message.
          *
          ...
          * **That matters here more than it would elsewhere, and the number is measured rather
          * than estimated** — at 390×844 with the row present against removed, stub-backed, one
          * collection of six places: **0 rows fully visible against 1, and 1 partly visible against
          * 2**, with the heading at y=500 against y=456. Not "buys some space": the difference
          * between a list with nothing readable in it and a list with a row in it.
          *
          * (An earlier estimate here said *"about 1.4 rows"*. That was read off a screenshot and it
          * was wrong — it was zero.)
          *
