...
| M11 presentation | Deck built directly from these documents; `how-the-system-works.md` is the study guide for the interview questions | `docs/archive/presentation-outline.md`, `docs/how-the-system-works.md` |
