...
### L0-F2 — Local resolve seam · `maps-geospatial` · depends: — · cut: never · **PARKED 2026-08-27**
...
### L0-F3 — Global resolver (D2b) · `maps-geospatial` + `security-privacy` · depends: F2 · cut: never · **PARKED 2026-08-27**
