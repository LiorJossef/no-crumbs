...
steps: [`archive/ms2-cloud-setup.md`](archive/ms2-cloud-setup.md). No schema yet — that is MS4.
...
compensates): [`archive/ms4-database.md`](archive/ms4-database.md).
...
**Deferred past MS5, from the `ms5-design` row list in [`archive/ms1-ms4-audit-handoff.md`](archive/ms1-ms4-audit-handoff.md).** None of them block the vertical slice, and each is recorded so it is not lost:
...
| `archive/presentation-outline.md` + deck | MS16 | **M11** |
