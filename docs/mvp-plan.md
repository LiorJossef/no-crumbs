...
`archive/product-ruling-after-the-save.md` (2026-08-29) ruled that the product's biggest after-the-save gap
...
in full in `archive/product-ruling-after-the-save.md` §4. The trip question — the case always cited for
...
`archive/handoff-2026-08-30-collections.md` §8. `user_tags` and OD-1 below are **untouched** and still open.
Design: `archive/ux-collections.md`. Schema: migrations `0024`/`0026`.
